...
export const jsonld = {
  ...
  primaryImageOfPage: {
    ...
    description: "Collage including the logos of Remix.run, fly.io & GitHub Actions followed by the articles headline",
  },
  image: [coverImage],
  dateCreated: "2021-12-21T20:00:00",
  dateModified: "2021-12-23T01:47:00",
