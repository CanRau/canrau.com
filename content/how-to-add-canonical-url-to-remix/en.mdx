...
export const jsonld = {
  ...
  dateModified: "2021-12-26T14:45:00",
...
So make sure, whatever way you use or prefer, to be consistent and always serve the same canonical URL so it won't change during renders and choose first if you want the canonical URL to be [with or without a trailing slash](/en/with-or-without-trailing-slash)
