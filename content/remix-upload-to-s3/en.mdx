...
> Note that there's still an (open) [issue](https://github.com/remix-run/remix/issues/1164) which limits file size at the moment, the [PR](https://github.com/remix-run/remix/pull/1766) has already been merged and I've been told the next Remix release (including this PR) should be published by tuesday 🥳
